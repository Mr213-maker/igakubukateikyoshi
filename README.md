...
<head>
    ...
    <meta property="og:site_name" content="医学部家庭教師掲示板" />
    ...
    <style>
        ...
        .testimonials-container { display: flex; flex-direction: column; gap: 25px; }
        .testimonial-card { background-color: #fafdff; border-left: 5px solid #0077cc; padding: 25px; border-radius: 8px; }
        .testimonial-card h3 { margin-top: 0; color: #005fa3; border-bottom: none; font-size: 1.2em; }
        .testimonial-card p { margin-bottom: 0; line-height: 1.8; }
...
<section id="testimonials">
    ...
    <div class="testimonials-container">
        <article class="testimonial-card">
            ...
            <p>第一志望の医学部合格に向けて、こちらの掲示板で素晴らしい先生に出会うことができました。<br>特に感謝しているのは、学習計画のきめ細やかさです。目先の模試対策といった短期的な計画はもちろんのこと、最終的なゴールを見据えた長期的な戦略まで、私の学力や志望校の特性に合わせて徹底的に考えてくださりました。<br>日々の学習で不安な点や伸び悩んでいる箇所を相談すると、すぐに的確なアドバイスをくれ、常に「先生と一緒に頑張っている」という心強さがありました。まさに二人三脚で受験を乗り越えられたと感じています。<br>医学部受験は孤独な戦いになりがちですが、本気で向き合ってくれる先生の存在が何よりの支えでした。本当にありがとうございました。</p>
        </article>
        <article class="testimonial-card">
            <h3>計画的な指導で、着実に実力がつきました</h3>
            <p>こちらの掲示板を通じて見つけた先生にお世話になりました。先生の指導で特に優れていると感じたのは、計画の立て方です。<br>まず、年間の学習スケジュールという長期的な視点での計画を一緒に立ててくれました。その上で、月単位、週単位の短期計画に落とし込み、今何をすべきかが常に明確な状態で学習を進めることができました。<br>自分一人では、どうしても目の前の課題に追われてしまいがちですが、先生が長期的な視点を持ってサポートしてくれたおかげで、焦ることなく、着実にステップアップしていくことができました。先生と二人三脚で一つ一つの課題をクリアしていく感覚は、大きな自信に繋がりました。<br>計画的に学習を進めたい方に、心からおすすめできる先生です。</p>
        </article>
        <article class="testimonial-card">
            <h3>親身な計画とサポートに感謝！</h3>
            <p>志望校合格という目標に向かって、短期・長期の両面から手厚い学習計画を立てていただきました。先生と二人三脚で、モチベーションを高く保ったまま走り抜くことができました。本当にありがとうございました！</p>
        </article>
    </div>
</section>
...
<section id="trial_flow">
    ...
    <div class="flow-steps">
        <div class="flow-step">
            ...
            <p>まずはお問い合わせフォームから、体験授業希望の旨をご連絡ください。ご質問やご相談だけでも歓迎です。</p>
        </div>
        <div class="flow-step">
            <h3>STEP 2：学習状況のヒアリング</h3>
            <p>担当者よりメールにてご連絡し、現在の学習状況、志望校、お悩みなどについて詳しくお伺いします。</p>
        </div>
        <div class="flow-step">
            <h3>STEP 3：最適な講師のマッチング</h3>
            <p>ヒアリング内容に基づき、生徒様の目標達成に最も貢献できると考えられる医学生講師を選定します。</p>
        </div>
        <div class="flow-step">
            <h3>STEP 4：体験授業の実施（60分 / 3,000円）</h3>
            <p>決定した講師とZoomにて体験授業を行います。実際の授業の雰囲気や講師との相性をご確認ください。</p>
        </div>
        <div class="flow-step">
...
<section id="contact" class="contact-section">
    ...
    <p>体験授業のお申し込みや、サービスに関するご質問はこちらのフォームからお気軽にご連絡ください。</p>
    <a href="https://docs.google.com/forms/d/1E_0jZ8WJGoaDiQ-1AeJqaRTRzUhMERLDmSPKXQ-YYuk/viewform" target="_blank" class="contact-button">お問い合わせフォームを開く</a>
</section>
